...
public class LinkedListTabulatedFunction implements TabulatedFunction, Function , Serializable {
    ...
    public static class LinkedListTabulatedFunctionFactory implements TabulatedFunctionFactory {
        ...
        public TabulatedFunction createTabulatedFunction(double leftX, double rightX, double[] values) {
            try {
                LinkedListTabulatedFunction list = new LinkedListTabulatedFunction(leftX, rightX, values);
                return list;
            }
            catch (Exception ex){
        ...
        public TabulatedFunction createTabulatedFunction(FunctionPoint[] points) {
            try {
                LinkedListTabulatedFunction list = new LinkedListTabulatedFunction(points);
                return list;
            }
            catch (Exception ex){
